...
import java.util.concurrent.Executors; //two threads one object but two jobs....
public class TwoThreadOneObject {
	public static void main(String[] args) {       
		...
		es.shutdown();    } }
/* * when a method is synchronizes, then only ONE thread can be inside the method... * 
 * even if the thread undergoes a interruption, still another thread cannot enter 
 * until the thread comes out of the method, another thread cannot enter a synchronized method 
 ...
 *  which means - when ramu in inside bookticket, somu cant enter givechange method also */
