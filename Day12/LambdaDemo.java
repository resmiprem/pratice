...
public class LambdaDemo {
	public static void main(String[] args) {  
		...
		public static void display(MyInter myinter) { myinter.met();} 
		public static void display2(MyInter2 myinter2) { myinter2.met2("hello world",11);    } 
		public static String displayReturn(MyInter3 myinter3) { return myinter3.met3("hello world......", 1000);   
		} 
	} 
	interface MyInter3{ public String met3(String s,int i); } 
	interface MyInter2{ public void met2(String s,int i); }
	@FunctionalInterface
	interface MyInter{ public void met();}
	class MyInterImpl implements MyInter{ @Override 
	public void met() {      
